...
[English](README.md) | 简体中文 | [日本語](README.ja.md) | [Español](README.es.md) | [Français](README.fr.md) | [Deutsch](README.de.md) | [Português](README.pt.md) | [Русский](README.ru.md) | [한국어](README.ko.md) | [العربية](README.ar.md)
...
| `CC_GYM_LANG` | 跟随系统 `$LANG` | 提示语言。支持 `en`、`zh`、`es`、`ja`、`fr`、`de`、`pt`、`ru`、`ko`、`ar`，识别不出回退 `en` |
| `CC_GYM_LIGHT_FILE` | 内置（按语言） | 自定义轻档动作清单文件 |
| `CC_GYM_HEAVY_FILE` | 内置（按语言） | 自定义重档动作清单文件 |
